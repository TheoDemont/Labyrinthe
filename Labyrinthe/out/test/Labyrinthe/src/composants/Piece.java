...
abstract public class Piece {
	...
	public void rotation(){
		...
		if(this.orientationPiece==4) this.orientationPiece=0;

		boolean temp = this.pointsEntree[3];
		this.pointsEntree[3] = this.pointsEntree[2];
		this.pointsEntree[2] = this.pointsEntree[1];
		this.pointsEntree[1] = this.pointsEntree[0];
		this.pointsEntree[0] = temp;
