    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<7; i++){
            for(int j=0; j<7; j++){
                ...
                plateau.positionnePiece(plateau.getPiece(i,j), i, j);
            }
        }
        IG.miseAJourAffichage();
        IG.attendreClic();
        ...
        for(int i=0; i<7; i++){
            for(int j=0; j<7; j++) {
                System.out.println(plateau.getPiece(i, j).toString());
            }
        }
        System.out.println(" ");
        ...
        //Test calculchemin
        int[][] testcalculchemin = plateau.calculeChemin(4,4,3,5);
        if(testcalculchemin != null){
            for(int i=0; i<testcalculchemin.length; i++){
                System.out.println(testcalculchemin[i][0] + " " + testcalculchemin[i][1]);
            }
        }
