...
public abstract class Joueur {
	...
	public int getNombreObjetsRecuperes() {
		return this.nombreObjetsRecuperes; // A Modifier
	}
	...
	public void setObjetsJoueur(Objet objetsARecuperer[]){
		this.objetARecuperer = new Objet[objetsARecuperer.length];
		for(int i=0; i<objetsARecuperer.length; i++){
			this.objetARecuperer[i] = objetsARecuperer[i];
		}
		// A Compléte
	}
	...
	public Objet getProchainObjet(){
		// A Modifier
		Objet resultat = this.objetARecuperer[0];
		for(int i=0; i<this.objetARecuperer.length; i++){
			if(objetARecuperer[i] != null) resultat = this.objetARecuperer[i];
		}
		return resultat;
	}
